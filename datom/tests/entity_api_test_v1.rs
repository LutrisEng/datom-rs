...
use datom::{prelude::*, EntityResult, Transaction, ID};

use datom::sled::*;

#[test]
fn entity_api_test_v1() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for _ in 1..5 {
...

        {
            ...
            let pmc_bio_after_retract_pmc_bio_tx =
                pmc_after_retract_pmc_bio_tx.get(bio_attr.into())?;
